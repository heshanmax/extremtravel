...
<header>
    <div class="sticky-nav">
        ...
        <div id="logo">
            <a id="goUp" href="#home-slider" title="SLET |"></a>
        </div>

        <nav id="menu">
            <ul id="menu-nav">
                <li class="current"><a href="#home-slider">Home</a></li>
                <li><a href="#work">Our Tours</a></li>
        ...
        <div class="row">
            <div class="span12">
                <div class="title-page">
                    ...
                    <h3 class="title-description">Check Out Our Tours..</h3>
                </div>
            </div>
        </div>
        <!-- End Title Page -->
            ...
            <div class="span12">
                <div class="row">
                    ...
                    <div class="span12 pagination-centered">
                        <a class="button button-large" href="<?php echo e(url('/'.'tours')); ?>">Click for More Tours!!</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="span4 profile">
                <div class="image-wrap">
                    ...
                    <img src="<?php echo e(asset('images/testi1.jpg')); ?>" alt="John Melvin">

                </div>
                <h3 class="profile-name">John Melvin</h3>
            ...
            <div class="span4 profile">
                <div class="image-wrap">
                    ...
                    <img src="<?php echo e(asset('images/testi2.jpg')); ?>" alt="Jane Maleesa">
                </div>
                <h3 class="profile-name">Jane Maleesa</h3>
                <p class="profile-description">"AMAZING experience. There is no way that we would’ve had the same experience if we planned this trip ourselves. Absolute Travel treated us better than we would’ve treated ourselves!"</p>
            ...
            <div class="span4 profile">
                <div class="image-wrap">
                    ...
                    <img src="<?php echo e(asset('images/testi3.jpg')); ?>" alt="Joshua Insanus">
