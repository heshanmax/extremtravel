<header>
    <div class="sticky-nav">
        ...
        <div id="logo">
            <a id="goUp" href="#home-" title="Srilanka Extream Travels">SLET</a>
        </div>

        <nav id="menu">
            <ul id="menu-nav">
                <li ><a href="<?php echo e(route('index')); ?>">Home</a></li>
                <li class="current"><a href="<?php echo e(url('/tours')); ?>">Our Tours</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="span6">
                    ...
                    <a class="button button-large" href="<?php echo e(route('tours.single',$randpost->id)); ?>" target="_blank">Read More </a>
                            ...
                            <ul id="thumbs">
                                ...
                                <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="item-thumbs span4 design" data-appear-top-offset="-300" data-animated="fadeInLeft">
                                        ...
                                        <a class="hover-wrap img-responsive" data-fancybox-group="gallery" title="The Dark" href="<?php echo e(route('tours.single',$post->id)); ?>" target="_blank">
